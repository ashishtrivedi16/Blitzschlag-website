...
#box2 {
 ...
 <div align="center" class="container">
  ...
  <option value="3">3</option>
					...
					<div  id="box2" ><br>
					<p>General admission: <a style="color:red;">Rs. 100/- per head</a><br>(Note-This ticket grants the participant to take part in technical, cultural events happening prior to pronite events.)</p>
					<p>Pronites:<br>1: Papa CJ, Rambasamba, Panache<br>2:Armaan Malik, Geeta Chandran<br>3:DJ NYK, Bhajan Sopori</p>
					<p>Note: Teams participating for Rambasamba, Panache will pay <a style="color:red;">Rs.100/- per head</a> for respective events and will be given general admission ticket.<br>Accommodation + Workshops + All Events for <a style="color:red;">Rs.1200</a> <br>Workshops + All events entry for <a style="color:red;">Rs.1000</a>.<br> Pronites + All events for <a style="color:red;">Rs.500</a>.
					<br> *Accommodation is fast filling. Reserve your space by paying at the earliest.<br> ** All prices are tentative</p><p><a style="color:red;"><strong>***Recent fee changes will apply only to new registrations. All those who have already paid before need not pay again.</strong></a></p>
					<h1>For more info Contact:</h1>
