       ...
       <ul>
          ...
          <li><a href='../cultural/index.html'>Cultural Events</a>
             <ul>
                ...
                <li><a href='../cultural/index.html#Fine Arts'>Fine Arts</a></li>
 ...
 <div align="center" class="container">
						...
						<div class="morph-content" style="overflow-y: auto;">
							<div>
								<div class="content-style-form content-style-form-2">
									<span class="icon icon-close">Close the dialog</span>
									<!--h2>Accommodation not open </h2--> <br>
  ...
  <option value="3">3</option>
			...
			<div  id="box2" ><br>
						<h1> Charges </h2>
							<p>
							<b>General Admission :</b> Rs 100 <br>
							<strong> Pronights(including general admission) </strong> <br>
							<b> One night : </b> Rs 200 <br>
							<b> Two nights : </b> Rs 300 <br>
							<b> Three nights : </b> Rs 400 <br><br>
							* General admission includes entry to all technical events during the 3 day extravaganza <br>
							<strong>Jaipur Darshan (9 am - 6 pm ) by Saya Tours : </strong> Rs 200  
						</p>
